...
//
//  Compute the IFFT of A using subroutines from FFTW.  The IFFT is
//     calculated along the first non-singleton dimension of the array.
//     Thus if A is a matrix, `ifft (A)' computes the IFFT for each column
//     of A.
//
...
//     dimension along which the IFFT is calculated, then A is truncated.
//   See also
//     moc_fft
//   Authors
